...
const CLIENT_ID = "229955476444-b3dmml1og0uveq28q7s09s9rho8270el.apps.googleusercontent.com"
...
class userController {
    ...
    static addTag(req, res) {
        Tag.findOne({
            name: req.body.watchTags
        })
        .then(tag => {
            if(!tag) {
                res.status(400).json({
                    message: `Your tag doesn't exist in this site`
                })
            } else {
